...
// Import UC r005
import R005HomeSleepingCell from 'components/RNOC1/R005-SleepingCell/R005HomeSleepingCell';
...
const MainPageRoute = (props: Props) => {
    const GetPage = (code: String) => {
        switch (code) {
            ...
            case "R005SleepingCell":
                  return <R005HomeSleepingCell />;
            default:
                return <Page404 />;
        }
    };
    ...
    return (
        <Routes>
            ...
            <Route path="/R005-Sleeping-Cell" element={<R005HomeSleepingCell />} />
