...
import categoryAlarmTypeFormInputJson from './FormInput.json';
interface Props {
  Id: string,
...
const CategoryAlarmTypeForm = (props: Props) => {  
  const [state, dispatch] = useReducer(Reducer, InitState)
  useEffect(() => {
    Actions.GetItem(props.Id, dispatch);
  }, [props.Id])
  let categoryAlarmTypeFormInput:any = categoryAlarmTypeFormInputJson;
  ...
  return(
    <>
      ...
      <CtrlDynamicForm options={props.Options} ref={refDynamicForm} initValues={state.DataItem} formDefs={categoryAlarmTypeFormInput} actionEvents={ActionEvents} />
    </>
  )
}
...
export default connect(mapState, mapDispatchToProps)(CategoryAlarmTypeForm);