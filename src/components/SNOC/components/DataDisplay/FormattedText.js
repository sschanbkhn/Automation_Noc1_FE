...
const highlightTerms = (text) => {
    const patterns = [
        ...
        { regex: /\btrue\b|\bTrue\b/g, className: 'highlight-green' }, // No replacement specified, use the original term
        { regex: /\bfalse\b|\bFalse\b|\bGx\b|\bGy\b/g, className: 'highlight-red' }, // No replacement specified, use the original term
