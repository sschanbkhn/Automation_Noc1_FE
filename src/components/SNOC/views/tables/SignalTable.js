...
const SignalTable = () => {
    ...
    useEffect(() => {
        dispatch(fetchLatestHealthcheckView({ host: searchHostRef.current, page: currentPage, platform: ['signal'] }));
        ...
        <React.Fragment>
            ...
            <Row>
                <Col md={12}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">Báo hiệu - Danh sách bản ghi healthcheck</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            {loading ? (
