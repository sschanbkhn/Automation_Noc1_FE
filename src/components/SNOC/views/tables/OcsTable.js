...
const OcsTable = () => {
    ...
    useEffect(() => {
        dispatch(fetchLatestHealthcheckView({ host: searchHostRef.current, page: currentPage, platform: ['ocs_sdp'] }));
        ...
        <React.Fragment>
                ...
                <Col md={12} className="mb-3">
                    <Form onSubmit={handleSearch} className="d-flex">
                        ...
                        <ExcelFile
                            ...
                            filename="ocs_healthcheck_export"
                        >
                            <ExcelSheet data={sortedItems} name="OCS Healthcheck">
            ...
            <Row>
                <Col md={12}>
                    <Card>
                        <Card.Header>
                            <Card.Title as="h5">OCS - Danh sách bản ghi healthcheck</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            {loading ? (
