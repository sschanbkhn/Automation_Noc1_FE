...
const DhttHistoricalReporting = () => {
  ...
  const handleReset = () => {
    ...
    setFilterStatus(""); setCurrentPage(1);
    paramsRef.current = { host: "", hours: "24", start: "", end: "", status: "" };
                ...
                <Row className="g-2">
                  ...
                  <Col md={2}>
                    <InputGroup>
                      ...
                      <Form.Select
                        value={hours}
                        onChange={e => { setHours(e.target.value); setStartDate(""); setEndDate(""); }}
                  ...
                  <Col md={2}>
                    <Form.Control
                      type="date"
                      value={startDate}
                      onChange={e => { setStartDate(e.target.value); setHours(""); }}
                      placeholder="Từ ngày"
                    />
                  </Col>
                  <Col md={2}>
                    <Form.Control
                      type="date"
                      value={endDate}
                      onChange={e => { setEndDate(e.target.value); setHours(""); }}
