...
//     setFormData((prev) => {
//       const clone = [...prev.sessionAgentsList];
//       if (clone.length <= 1) return prev; // ít nhất 1 dòng
...
//         ip_rtp: (a.ip_rtp || "").trim(),
//         subnet_rtp: (a.subnet_rtp || "").trim(),
...
//     // Chuẩn hoá danh sách session_agents_payload
//     const session_agents_payload = formData.sessionAgentsList
//       .map((a) => ({
//         hostname: (a.hostname || "").trim(),
//         ip_sip: (a.ip_sip || "").trim(),
//         subnet_sip: (a.subnet_sip || "").trim(),
//         ip_rtp: (a.ip_rtp || "").trim(),
//         subnet_rtp: (a.subnet_rtp || "").trim(),
//         max_sessions: a.max_sessions ? Number(a.max_sessions) : null,
//       }))
//       .filter(
//         (a) =>
//           a.hostname &&
...
//     const payload = {
//       partner_name: formData.partner, // map sang field backend
...
//           {formData.sessionAgentsList.map((ag, idx) => (
...
//                     value={ag.ip_rtp}
//                     onChange={(e) =>
//                       handleAgentChange(idx, "ip_rtp", e.target.value)
//                     }
...
//                     value={ag.subnet_rtp}
//                     onChange={(e) =>
//                       handleAgentChange(idx, "subnet_rtp", e.target.value)
//                     }
//                     placeholder="VD: 255.255.255.255"
//                   />
//                 </Form.Group>
