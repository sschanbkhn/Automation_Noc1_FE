...
<<<<<<< HEAD
      ...
      >
        ...
        <Modal.Body style={{ maxHeight: "75vh", overflowY: "auto", background: "#0d1117", padding: "1rem" }}>
          <div style={{ color: "#58a6ff", fontSize: "0.75rem", marginBottom: 12,
          ...
          {traceLoading ? (
            ...
            <>
              ...
              <div className="d-flex gap-3 mb-3 flex-wrap">
                {/* ICMP Ping */}
                <div style={{ background: traceResult.ping?.ok ? "#0f2d1a" : "#2d0f0f",
                ...
                {/* TCP Port */}
                <div style={{ background: traceResult.tcp?.ok ? "#0f2d1a" : "#2d0f0f",
              ...
              {/* ── Traceroute hops / raw ─────────────────────────── */}
              {traceResult.status === "unavailable" ? (
                <div style={{ background: "#161b22", border: "1px solid #d29922",
                ...
                <pre style={{ color: "#a8ff78", background: "#0d1117", fontSize: "0.78rem",
                  ...
                  <thead>
                    <tr style={{ borderBottom: "1px solid #30363d" }}>
                      {["#","IP","Hostname","RTT 1","RTT 2","RTT 3","Avg"].map(h => (
                        <th key={h} style={{ color: "#8b949e", background: "transparent",
                                             textAlign: h.startsWith("RTT") || h==="Avg" ? "right" : "left" }}>{h}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody>
