...
let BACKEND_SERVER = process.env.REACT_APP_SNOC_API_URL || "http://10.147.50.100:8000/api";
let BACKEND_SERVER_MEDIA = process.env.REACT_APP_SNOC_API_URL ? process.env.REACT_APP_SNOC_API_URL.replace('/api', '') : "http://10.147.50.100:8000";
