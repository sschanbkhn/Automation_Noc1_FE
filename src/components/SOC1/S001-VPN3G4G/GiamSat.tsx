...
const Monitor = () => {
  ...
  const configModules: ConfigModule[] = [
    ...
    },
    {
      id: 2,
      title: "Data Storage",
      description: "Organize Database Files",
      icon: faDatabase,
      iconColor: "#10b981",
      status: "active",
    },
  ...
  const handleDownloadBE = () => {
    // Gọi API download file BE
    window.location.href = `${API_URL}/download/thong-ke-lech/`; 
  };
          ...
          <div
            ...
            onClick={async () => {
              ...
              try {
                ...
                if (module.id === 1) {
                  //Gọi log và đưa vào bảng
                  const response = await fetch(`${API_URL}/thong-ke-log/`, {
                    method: "GET",
                    headers: { "Content-Type": "application/json" },
                  });
                  const result = await response.json();
                  // result phải trả về mảng log [{timestamp, host, command, output}, ...]
                  if (Array.isArray(result)) {
                    setLogs(result);
                    setShowLog(true);
                  } else {
                    alert("⚠️ Không có log nào được trả về");
                  }
                }
                else {
          ...
          >
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  ...
                  <p style={{ margin: 0, fontSize: "14px", opacity: 0.9 }}>Data Management</p>
                </div>
              </div>
            ...
            >
              ...
              >
                ...
                <tbody>
                  <tr>
                    <td style={{ padding: "12px" }}>Download File thống kê chuẩn hoá BE của dịch vụ</td>
                    <td style={{ padding: "12px" }}>
                      <button
                        onClick={handleDownloadBE}
                        style={{
                          padding: "6px 12px",
                  ...
                  <tr>
                    <td style={{ padding: "12px" }}>Download File thống kê đối soát giữa BE và CSDL của dịch vụ</td>
                    <td style={{ padding: "12px" }}>
                      <button
                        onClick={handleDownloadCSDL}
                        style={{
                          padding: "6px 12px",
