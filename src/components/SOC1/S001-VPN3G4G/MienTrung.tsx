...
import Circle_box_MT from "./Circle_box_MT"
import Circle_box_ds_MT from "./Circle_box_ds_MT";
...
const handleBoxClick = (
 ...
 if (index === 0) {
  ...
  const displayDanhSachTenAPN = () =>{
    fetch(`${API_URL}/thong-ke-loi/mt/khong_dung_apn/`)
      .then((res) => res.json())
      .then((data) => {
    ...
    fetch(`${API_URL}/doi_soat/mt/lech_Pgw/`)
      .then((res) => res.json())
      .then((data) => {
