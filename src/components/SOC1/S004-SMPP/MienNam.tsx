...
function MienBac({ isDisplayed }: MienBacProps) {
  ...
  const displayTongLechSystemId = () => {
    return fetch(`${API_URL}/thong-ke-loi/mn/khong_dung_systemid/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechState= () => {
    return fetch(`${API_URL}/thong-ke-loi/mn/khong_dung_state/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechBindType = () => {
    return fetch(`${API_URL}/thong-ke-loi/mn/khong_dung_bindtype/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechIps = () => {
    return fetch(`${API_URL}/thong-ke-loi/mn/khong_dung_ips/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechConnection = () => {
    return fetch(`${API_URL}/thong-ke-loi/mn/khong_dung_connection/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayDoiSoatBindType = () => {
    return fetch(`${API_URL}/doi-soat/mn/lech_bindtype/`)
      .then((res) => res.json())
      .then((data) => {
          ...
          <div className="box_trai_zone1" style={{ width: '50%', height: '110vh', display: 'flex', flexDirection: 'column', position: 'relative', gap: '10px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
              ...
              <div style={{ height: '65vh', flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' ,padding:'10px 10px'}}>
                <BoxThongKeMN onClickBox={handleBoxClick} isDisplayed={isDisplayed} />  {/* ✅ truyền callback */}
              </div>
            </div>
          </div>
