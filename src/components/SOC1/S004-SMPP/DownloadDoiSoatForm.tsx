  ...
  const handleDownload = async (dichVu: DichVu, fileType: "chua_chuan_hoa" | "doi_soat") => {
    ...
    apiPath =
        fileType === "chua_chuan_hoa"  
          ? "smpp-download-thongke"
          : "smpp-download-doisoat";
  ...
  return (
    <div style={sectionStyle}>
      ...
      <div style={{ display: "grid", gap: "10px" }}>
        <button
          onClick={() => handleDownload("smpp", "chua_chuan_hoa")}
        ...
        >
          {loading === "chua_chuan_hoa" ? "⏳ Đang tải..." : "SMPP - Chưa chuẩn hoá BE"}
        </button>

         <button
          onClick={() => handleDownload("smpp", "doi_soat")}
          disabled={loading !== null}
          style={{
            ...baseButtonStyle,
        ...
        >
          {loading === "doi_soat" ? "⏳ Đang tải..." : "SMPP - Đối soát BE vs CSDL"}
        </button>
      </div>
    </div>
  );
