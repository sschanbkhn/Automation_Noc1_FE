...
function MienBac({ isDisplayed }: MienBacProps) {
  ...
  const displayTongLechSpid = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_spid/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechTps= () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_tps/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechIp = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_ip/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechAddress = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_address/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechUrl = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_url/`)
      .then((res) => res.json())
      .then((data) => {
        setDanhSachLechUrl(data); // data là mảng object thiết bị
      });
  }
  const displayTongLechGateway = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_gateway/`)
      .then((res) => res.json())
      .then((data) => {
        setDanhSachLechUrl(data); // data là mảng object thiết bị
      });
