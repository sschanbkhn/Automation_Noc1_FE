  ...
  const handleDownload = async (dichVu: DichVu, fileType: "chua_chuan_hoa" | "doi_soat") => {
    ...
    apiPath =
        fileType === "chua_chuan_hoa"  
          ? "ussd-download-thongke"
          : "ussd-download-doisoat";
  ...
  return (
    <div style={sectionStyle}>
      ...
      <div style={{ display: "grid", gap: "10px" }}>
        <button
          onClick={() => handleDownload("ussd", "chua_chuan_hoa")}
        ...
        >
          {loading === "chua_chuan_hoa" ? "⏳ Đang tải..." : "USSD - Chưa chuẩn hoá BE"}
        </button>

         <button
          onClick={() => handleDownload("ussd", "doi_soat")}
          disabled={loading !== null}
          style={{
            ...baseButtonStyle,
        ...
        >
          {loading === "doi_soat" ? "⏳ Đang tải..." : "USSD - Đối soát BE vs CSDL"}
        </button>
      </div>
    </div>
  );
