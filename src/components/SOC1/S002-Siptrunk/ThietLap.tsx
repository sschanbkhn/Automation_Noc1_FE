...
const Configuration = () => {
  ...
  const [executionLog_1, setExecutionLog_1] = useState([
    ...
    { email: "dovietduc@vnpt.vn", department: "Trung tâm SOC", note: "Đã gửi email số liệu thành công" },
  ]);
          ...
          <div
            ...
            onClick={async () => {
              ...
              try {
                ...
                if (module.id === 1) {
                  const confirmRun = window.confirm("Bạn có chắc chắn muốn chạy workflow SOC-Siptrunk không?");
                  if (!confirmRun) {
                    setExecutionLog(prev => [
                      ...prev,
                      {
                        time: new Date().toLocaleString(),
                        workflow: "SOC-Siptrunk",
                        status: "⚠️",
