...
function MienBac({ isDisplayed }: MienBacProps) {
  ...
  const [soKenhBeChuaChuanHoaMb, setSoKenhBeChuanChuanHoaMb] = useState(0);
  ...
  useEffect(() => {
    ...
    fetch(`${API_URL}/thong-ke-loi/count/mb/total/`)
      .then(res => res.ok ? res.json() : { count: 0 })
      .then(data => setSoKenhBeChuanChuanHoaMb(data.count ?? 0))
      .catch(err => setSoKenhBeChuanChuanHoaMb(0));
  }, []);
  ...
  const displayTongLechChannel = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_kenh/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechDes = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_sip_contact/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechSipInfo = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_sip_info/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechRoute = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_routing/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechTrung = () => {
    return fetch(`${API_URL}/thong-ke-loi/mb/khong_dung_trung_number/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayDoiSoatTocDo = () => {
    return fetch(`${API_URL}/doi-soat/mb/lech_tocdo/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayDoiSoatDest = () => {
    return fetch(`${API_URL}/doi-soat/mb/lech_destination/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayDoiSoatInfo = () => {
    return fetch(`${API_URL}/doi-soat/mb/lech_acc_info/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayDoiSoatMoQte = () => {
    return fetch(`${API_URL}/doi-soat/mb/lech_mo_qte/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayDoiSoatBrandName = () => {
    return fetch(`${API_URL}/doi-soat/mb/lech_brandname/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayDoiSoatAddIncome = () => {
    return fetch(`${API_URL}/doi-soat/mb/lech_address_incoming/`)
      .then((res) => res.json())
      .then((data) => {
            ...
            >
              ...
              {loaiBang === "ds_tocdo" && (
                loadingDs
                  ...
                  : <BangThongTinDoiSoatTQ
                    title="Danh sách số cuộc gọi đồng thời lệch đối soát"
                    data={danhSachDoiSoatTocDo}
