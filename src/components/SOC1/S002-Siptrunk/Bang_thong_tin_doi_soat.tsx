...
// 👉 Hàm format số: bỏ ".0" nếu là số nguyên
        ...
        <table className="bang_apn">
          <thead>
            <tr className="tieu_de">
              ...
              <th className="tieu_de">Address disabale (BE)</th>
              <th className="tieu_de">values_added (CSDL)</th>
              <th className="tieu_de">Khoá gọi ra (BE)</th>
              <th className="tieu_de">Routing table (BE)</th>
              <th className="tieu_de">Category (CSDL)</th>
              <th className="tieu_de">Service type (CSDL)</th>
              <th className="tieu_de">Brandname (CSDL)</th>
