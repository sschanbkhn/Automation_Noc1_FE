    ...
    if (dichVu === "ims") {
      apiPath =
        fileType === "chua_chuan_hoa"  
          ? "ims-download-thongke"
          : "ims-download-doisoat";
    } else {
      apiPath =
        fileType === "chua_chuan_hoa"
          ? "sip-download-thongke"
          : "sip-download-doisoat";
    }
  ...
  return (
    <div style={sectionStyle}>
      ...
      <div style={{ display: "grid", gap: "10px" }}>
        <button
          onClick={() => handleDownload("ims", "chua_chuan_hoa")}
        ...
        >
          {loading === "chua_chuan_hoa" ? "⏳ Đang tải..." : "IMS - Chưa chuẩn hoá BE"}
        </button>

         <button
          onClick={() => handleDownload("ims", "doi_soat")}
          disabled={loading !== null}
          style={{
            ...baseButtonStyle,
        ...
        >
          {loading === "doi_soat" ? "⏳ Đang tải..." : "IMS - Đối soát BE vs CSDL"}
        </button>

        <button
          onClick={() => handleDownload("aaranet", "chua_chuan_hoa")}
          disabled={loading !== null}
          style={{
            ...baseButtonStyle,
            background: "#15803d",
        ...
        >
          Aaranet - Chưa chuẩn hoá BE
        </button>

        <button
          onClick={() => handleDownload("aaranet", "doi_soat")}
          disabled={loading !== null}
          style={{
            ...baseButtonStyle,
            background: "#1e3a8a",
          ...
          onMouseOver={(e) =>
            (e.currentTarget.style.background = "#1d2f6f")
          }
          onMouseOut={(e) =>
            (e.currentTarget.style.background = "#1e3a8a")
          }
        >
          Aaranet - Đối soát BE vs CSDL
        </button>
      </div>
    </div>
  );
