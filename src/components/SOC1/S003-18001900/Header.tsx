// function Header() {
//     return(
//         <h2 className="text_display_top">Dashboard dịch vụ VPN3G4G</h2>
//     );
// };
...
function Header() {
  ...
  return (
    <animated.div 
      style={{
        ...headerAnimation,
        background: 'linear-gradient(135deg, #16b895ff 0%, #47e7c5ff 50%, #cebcebff 100%)',
