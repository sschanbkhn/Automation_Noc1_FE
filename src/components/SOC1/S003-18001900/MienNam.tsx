...
function MienNam({ isDisplayed }: MienNamProps) {
  ...
  //action đóng bảng hiển thị chi tiết
  ...
  const displayTongLechAccInfo = () => {
    return fetch(`${API_URL}/thong-ke-loi/mn/khong_dung_accinfo/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechSoDich = () => {
    return fetch(`${API_URL}/thong-ke-loi/mn/khong_dung_sodich/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayTongLechDichVu = () => {
    return fetch(`${API_URL}/thong-ke-loi/mn/khong_dung_dichvu/`)
      .then((res) => res.json())
      .then((data) => {
  ...
  const displayDoiSoatSoDich = () => {
    return fetch(`${API_URL}/doi-soat/mn/lech_sodich/`)
      .then((res) => res.json())
      .then((data) => {
