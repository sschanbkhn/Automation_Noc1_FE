...
const EricssonTable: React.FC<Props> = ({
    data,
    isLoading,
    currentPage,
    pageSize,
                    ...
                    <thead className="thead-light">
                        <tr>
                            ...
                            <th style={{ 
                                ...
                                borderBottom: '2px solid #dee2e6',
                                cursor: 'pointer'
                            }} onClick={() => handleSort('BandwidthDL')}>
                                Bandwidth DL {getSortIcon('BandwidthDL')}
                            </th>
                            <th style={{ 
                                color: '#495057',
                                fontWeight: 'bold',
                                ...
                                borderBottom: '2px solid #dee2e6',
                                cursor: 'pointer'
                            }} onClick={() => handleSort('BandwidthUL')}>
                                Bandwidth UL {getSortIcon('BandwidthUL')}
                            </th>
                            <th style={{ 
                                color: '#495057',
                                fontWeight: 'bold',
                        ...
                        {isLoading ? (
                            ...
                            paginatedData.map((item, index) => (
                                <tr key={index} style={{ fontSize: '13px' }}>
                                    ...
                                    <td style={{ padding: '8px' }}>{item.BandwidthDL}</td>
                                    <td style={{ padding: '8px' }}>{item.BandwidthUL}</td>
                                    ...
                                    <td className="text-center" style={{ padding: '8px' }}>{item.RSI}</td>
