...
const Zte4GTable: React.FC<Props> = ({
    data,
    isLoading,
    currentPage,
    pageSize,
        ...
        <div>
            <div className="row mb-3">
                <div className="col-md-6">
                    <h5>ZTE BTS Data Management</h5>
                    <p className="text-muted">
                        Hiển thị {paginatedData.length} trong số {sortedData.length} bản ghi
                        {searchTerm && ` (lọc từ ${data.length} tổng cộng)`}
                    </p>
                </div>
