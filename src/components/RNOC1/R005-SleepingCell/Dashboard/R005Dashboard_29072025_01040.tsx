  ...
  >
    <div className="d-flex align-items-center">
      ...
      <div style={{ minWidth: '25px' }}>
        <div className="d-flex flex-column" style={{ fontSize: '11px', fontWeight: 'bold', gap: '2px', lineHeight: '1.2' }}>
...
{/* LSN Province - Longer Bars Design */}
<div className="mb-4">
  <div 
  ...
  >
    ...
    {/* Province Name */}
    <div className="me-4" style={{ minWidth: '50px' }}>
      <h5 className="fw-bold mb-0" style={{ fontSize: '18px', color: '#1f2937' }}>LSN</h5>
    </div>
    
    {/* Bars Section - Maximum Width */}
    <div className="flex-grow-1">
      <div className="row g-2">
        {/* Total bar */}
        <div className="col-12">
          <div className="d-flex align-items-center">
            <span className="me-3" style={{ fontSize: '11px', color: '#6b7280', minWidth: '55px' }}>Total</span>
            ...
            <span className="ms-3 fw-bold" style={{ fontSize: '13px', color: '#f59e0b', minWidth: '30px', textAlign: 'right' }}>34</span>
          </div>
        </div>
        ...
        <div className="col-12">
          <div className="d-flex align-items-center">
            <span className="me-3" style={{ fontSize: '11px', color: '#6b7280', minWidth: '55px' }}>Resolved</span>
            <div className="flex-grow-1 position-relative">
              <div 
                style={{ 
                  height: '12px',
            ...
            <span className="ms-3 fw-bold" style={{ fontSize: '13px', color: '#10b981', minWidth: '30px', textAlign: 'right' }}>24</span>
          </div>
        </div>
        ...
        <div className="col-12">
          <div className="d-flex align-items-center">
            <span className="me-3" style={{ fontSize: '11px', color: '#6b7280', minWidth: '55px' }}>Manual</span>
            <div className="flex-grow-1 position-relative">
              <div 
                style={{ 
                  height: '12px',
            ...
            <span className="ms-3 fw-bold" style={{ fontSize: '13px', color: '#ef4444', minWidth: '30px', textAlign: 'right' }}>10</span>
          </div>
        </div>
      </div>
    </div>
...
<div className="mb-4">
  ...
  >
    ...
    {/* Labels column + Bars column + Numbers column */}
    <div className="d-flex flex-grow-1">
      {/* Labels column - close to icon/province */}
      <div className="me-3" style={{ minWidth: '60px' }}>
        <div className="d-flex flex-column justify-content-center" style={{ height: '100%' }}>
          ...
          <div style={{ height: '20px', display: 'flex', alignItems: 'center' }}>
            <span style={{ fontSize: '11px', color: '#6b7280' }}>Resolved</span>
          </div>
          <div style={{ height: '20px', display: 'flex', alignItems: 'center' }}>
            <span style={{ fontSize: '11px', color: '#6b7280' }}>Manual</span>
          </div>
        </div>
      </div>
      
      {/* Bars column - longer bars */}
      ...
      <div style={{ minWidth: '30px' }}>
        <div className="d-flex flex-column justify-content-center">
          <div style={{ height: '20px', display: 'flex', alignItems: 'center' }}>
            <span className="fw-bold" style={{ fontSize: '12px', color: '#f59e0b' }}>34</span>
          </div>
          <div style={{ height: '20px', display: 'flex', alignItems: 'center' }}>
            <span className="fw-bold" style={{ fontSize: '12px', color: '#10b981' }}>24</span>
          </div>
          <div style={{ height: '20px', display: 'flex', alignItems: 'center' }}>
            <span className="fw-bold" style={{ fontSize: '12px', color: '#ef4444' }}>10</span>
          </div>
        </div>
      </div>
    </div>
...
<div className="mb-4">
  ...
  >
    ...
    {/* Three bars as one solid block */}
    <div className="flex-grow-1 me-3">
      <div>
        {/* Single container with 3 stacked bars - no gaps */}
        <div style={{ position: 'relative' }}>
          {/* Total bar - 34 */}
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', lineHeight: '8px', height: '8px' }}>
            <div style={{ 
              height: '8px',
              backgroundColor: '#f59e0b',
              width: '100%',
            ...
            <span style={{ marginLeft: '8px', fontWeight: 'bold', fontSize: '12px', color: '#f59e0b', minWidth: '25px', lineHeight: '12px' }}>34</span>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', lineHeight: '8px', height: '8px' }}>
            ...
            <span style={{ marginLeft: '8px', fontWeight: 'bold', fontSize: '12px', color: '#10b981', minWidth: '25px', lineHeight: '12px' }}>24</span>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', lineHeight: '8px', height: '8px' }}>
            ...
            <span style={{ marginLeft: '8px', fontWeight: 'bold', fontSize: '12px', color: '#ef4444', minWidth: '25px', lineHeight: '12px' }}>10</span>
          </div>
        </div>
      </div>
    </div>
...
<div className="mb-4">
  ...
  >
    ...
    {/* Three bars completely touching - no gaps */}
    <div className="flex-grow-1 me-3">
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0px' }}>
          ...
          ></div>
          <span style={{ marginLeft: '8px', fontWeight: 'bold', fontSize: '12px', color: '#f59e0b', minWidth: '25px' }}>34</span>
        </div>
        
        {/* Resolved bar */}
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0px', marginTop: '-1px' }}>
          <div 
            style={{ 
              height: '8px',
              backgroundColor: '#10b981',
          ...
          ></div>
          <span style={{ marginLeft: '8px', fontWeight: 'bold', fontSize: '12px', color: '#10b981', minWidth: '25px' }}>24</span>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '-1px' }}>
          ...
          ></div>
          <span style={{ marginLeft: '8px', fontWeight: 'bold', fontSize: '12px', color: '#ef4444', minWidth: '25px' }}>10</span>
        </div>
      </div>
    </div>
  </div>
