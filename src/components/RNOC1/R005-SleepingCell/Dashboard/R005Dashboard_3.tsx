    ...
    <Card.Body className="p-4">
      ...
      <Row className="g-4">
        ...
        <Col lg={5}>
          ...
          <div className="position-relative" style={{background: 'linear-gradient(135deg, #f8fafc, #e2e8f0)', borderRadius: '12px', padding: '20px', minHeight: '280px'}}>
            
            {/* Chart Title */}
            <div className="text-center mb-3">
              <small className="text-muted fw-medium">Cells by Province</small>
            </div>
            ...
            <div className="d-flex flex-column gap-3">
              ...
              <div>
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <span style={{fontSize: '12px', fontWeight: 'bold'}}>LSN</span>
                  <span style={{fontSize: '11px', color: '#6b7280'}}>34 cells (71%)</span>
                </div>
                <div className="position-relative" style={{height: '16px', backgroundColor: '#e5e7eb', borderRadius: '8px'}}>
                  <div style={{
                    width: '100%',
                    height: '100%',
              ...
              <div>
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <span style={{fontSize: '12px', fontWeight: 'bold'}}>LCU</span>
                  <span style={{fontSize: '11px', color: '#6b7280'}}>13 cells (85%)</span>
                </div>
                <div className="position-relative" style={{height: '16px', backgroundColor: '#e5e7eb', borderRadius: '8px'}}>
                  <div style={{
                    width: '38%',
              ...
              <div>
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <span style={{fontSize: '12px', fontWeight: 'bold'}}>LCI</span>
                  <span style={{fontSize: '11px', color: '#6b7280'}}>9 cells (78%)</span>
                </div>
                <div className="position-relative" style={{height: '16px', backgroundColor: '#e5e7eb', borderRadius: '8px'}}>
                  <div style={{
                    width: '26%',
              ...
              <div>
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <span style={{fontSize: '12px', fontWeight: 'bold'}}>SLA</span>
                  <span style={{fontSize: '11px', color: '#6b7280'}}>6 cells (100%)</span>
                </div>
                <div className="position-relative" style={{height: '16px', backgroundColor: '#e5e7eb', borderRadius: '8px'}}>
                  <div style={{
                    width: '18%',
              ...
              <div>
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <span style={{fontSize: '12px', fontWeight: 'bold'}}>DBN</span>
                  <span style={{fontSize: '11px', color: '#6b7280'}}>2 cells (100%)</span>
                </div>
                <div className="position-relative" style={{height: '16px', backgroundColor: '#e5e7eb', borderRadius: '8px'}}>
                  <div style={{
                    width: '6%',
              ...
              <div>
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <span style={{fontSize: '12px', fontWeight: 'bold'}}>CBG</span>
                  <span style={{fontSize: '11px', color: '#6b7280'}}>1 cell (100%)</span>
                </div>
                <div className="position-relative" style={{height: '16px', backgroundColor: '#e5e7eb', borderRadius: '8px'}}>
                  <div style={{
                    width: '3%',
            ...
            <div className="mt-3 pt-2 border-top">
              <div className="d-flex justify-content-center gap-3 flex-wrap">
                <div className="d-flex align-items-center">
                  <div style={{width: '12px', height: '12px', backgroundColor: '#10b981', borderRadius: '2px', marginRight: '4px'}}></div>
                  <small style={{fontSize: '10px'}}>85%+ Success</small>
                </div>
                <div className="d-flex align-items-center">
                  <div style={{width: '12px', height: '12px', backgroundColor: '#f59e0b', borderRadius: '2px', marginRight: '4px'}}></div>
                  <small style={{fontSize: '10px'}}>70-84% Success</small>
                </div>
                <div className="d-flex align-items-center">
                  <div style={{width: '12px', height: '12px', backgroundColor: '#8b5cf6', borderRadius: '2px', marginRight: '4px'}}></div>
                  <small style={{fontSize: '10px'}}>Below 80%</small>
                </div>
              </div>
            </div>
          </div>
