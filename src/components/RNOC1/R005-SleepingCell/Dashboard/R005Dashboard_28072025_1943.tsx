    ...
    <Card.Body className="p-4">
      ...
      <div className="mb-4">
        ...
        <Row className="g-3">
          {/* SLA Province Card */}
          <Col md={4}>
            <Card className="border-0" style={{backgroundColor: '#f0f9ff', borderRadius: '12px', minHeight: '120px'}}>
              <Card.Body className="p-4">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div className="d-flex align-items-center">
                    <span className="badge me-2" style={{
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center me-2">
                    ...
                    <span className="fw-bold" style={{fontSize: '14px'}}>6</span>
                    <small className="text-muted ms-1" style={{fontSize: '12px'}}>cells</small>
                  </div>
                  <div className="d-flex align-items-center me-2">
                    <span style={{fontSize: '1.1rem', marginRight: '6px'}}>😴</span>
                    <span className="fw-bold text-danger" style={{fontSize: '14px'}}>5</span>
                    <small className="text-muted ms-1" style={{fontSize: '12px'}}>sleeping</small>
                  </div>
                  <div className="d-flex align-items-center">
                    <span style={{fontSize: '1.1rem', marginRight: '6px'}}>✅</span>
                    <span className="fw-bold text-success" style={{fontSize: '14px'}}>6</span>
                    <small className="text-muted ms-1" style={{fontSize: '12px'}}>recovered</small>
                  </div>
                </div>
              </Card.Body>
            </Card>
          ...
          {/* LSN Province Card */}
          <Col md={4}>
            <Card className="border-0" style={{backgroundColor: '#fef3c7', borderRadius: '12px', minHeight: '120px'}}>
              <Card.Body className="p-4">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div className="d-flex align-items-center">
                    <span className="badge me-2" style={{
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center">
                    ...
                    <small className="text-muted ms-1">cells</small>
                  </div>
                  <div className="d-flex align-items-center">
                    <span style={{fontSize: '1.2rem', marginRight: '4px'}}>😴</span>
                    <span className="fw-bold text-danger">34</span>
                    <small className="text-muted ms-1">sleeping</small>
                  </div>
                  <div className="d-flex align-items-center">
                    <span style={{fontSize: '1.2rem', marginRight: '4px'}}>✅</span>
                    <span className="fw-bold text-success">24</span>
                    <small className="text-muted ms-1">recovered</small>
                  </div>
                </div>
              </Card.Body>
            </Card>
          ...
          {/* LCU Province Card */}
          <Col md={4}>
            <Card className="border-0" style={{backgroundColor: '#ecfdf5', borderRadius: '12px', minHeight: '120px'}}>
              <Card.Body className="p-4">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div className="d-flex align-items-center">
                    <span className="badge me-2" style={{
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div className="d-flex align-items-center">
                    <span style={{fontSize: '1.2rem', marginRight: '4px'}}>😴</span>
                    <span className="fw-bold text-danger">13</span>
                    <small className="text-muted ms-1">sleeping</small>
                  </div>
                  <div className="d-flex align-items-center">
                    <span style={{fontSize: '1.2rem', marginRight: '4px'}}>✅</span>
          ...
          {/* LCI Province Card */}
          <Col md={4}>
            <Card className="border-0" style={{backgroundColor: '#f3e8ff', borderRadius: '12px'}}>
              <Card.Body className="p-3">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div className="d-flex align-items-center">
                    <span style={{fontSize: '1.2rem', marginRight: '4px'}}>😴</span>
                    <span className="fw-bold text-danger">9</span>
                    <small className="text-muted ms-1">sleeping</small>
                  </div>
                  <div className="d-flex align-items-center">
                    <span style={{fontSize: '1.2rem', marginRight: '4px'}}>✅</span>
                    <span className="fw-bold text-success">7</span>
                    <small className="text-muted ms-1">recovered</small>
                  </div>
                </div>
              </Card.Body>
          ...
          {/* DBN Province Card */}
          <Col md={4}>
            <Card className="border-0" style={{backgroundColor: '#f0f9ff', borderRadius: '12px'}}>
              <Card.Body className="p-3">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div className="d-flex align-items-center">
                    <span className="badge me-2" style={{
          ...
          {/* CBG Province Card */}
          <Col md={4}>
            <Card className="border-0" style={{backgroundColor: '#fdf2f8', borderRadius: '12px'}}>
              <Card.Body className="p-3">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div className="d-flex align-items-center">
                    <span className="badge me-2" style={{
                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center">
                    ...
                    <small className="text-muted ms-1">cell</small>
                  </div>
                  <div className="d-flex align-items-center">
                    <span style={{fontSize: '1.2rem', marginRight: '4px'}}>😴</span>
          ...
          <Col lg={8}>
            <Card className="border-0" style={{backgroundColor: '#f8fafc', borderRadius: '16px'}}>
              <Card.Body className="p-4">
                ...
                <div className="d-flex align-items-end justify-content-center gap-4" style={{height: '220px', marginBottom: '20px'}}>
                ...
                {/* Legend */}
                <div className="d-flex justify-content-center gap-4 pt-3 border-top">
                  <div className="d-flex align-items-center">
                    <div style={{
                      width: '14px', 
                      height: '14px', 
                    ...
                    <small style={{fontSize: '11px', color: '#6b7280', fontWeight: '500'}}>High Success</small>
                  </div>
                  <div className="d-flex align-items-center">
                    <div style={{
                      width: '14px', 
                    ...
                    <small style={{fontSize: '11px', color: '#6b7280', fontWeight: '500'}}>Need Attention</small>
                  </div>
                </div>
              </Card.Body>
            </Card>
    ...
    <Card.Body className="p-4">
      ...
      <div className="mb-4">
        ...
        <Row className="g-3">
            ...
            <Card className="border-0" style={{backgroundColor: '#f0f9ff', borderRadius: '12px'}}>
              <Card.Body className="p-3">
                ...
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div className="d-flex align-items-center">
                    <span style={{fontSize: '1.2rem', marginRight: '4px'}}>✅</span>
                    <span className="fw-bold text-success">6</span>
                    <small className="text-muted ms-1">recovered</small>
                  </div>
                </div>
              </Card.Body>
          ...
          {/* LSN Province Card */}
          <Col md={4}>
            <Card className="border-0" style={{backgroundColor: '#fef3c7', borderRadius: '12px'}}>
              <Card.Body className="p-3">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div className="d-flex align-items-center">
                    <span className="badge me-2" style={{
          ...
          {/* LCU Province Card */}
          <Col md={4}>
            <Card className="border-0" style={{backgroundColor: '#ecfdf5', borderRadius: '12px'}}>
              <Card.Body className="p-3">
                <div className="d-flex justify-content-between align-items-center mb-3">
                  <div className="d-flex align-items-center">
                    <span className="badge me-2" style={{
  ...
  <Card className="border-0 shadow-sm">
    <Card.Body className="p-4">
      <div className="d-flex align-items-center mb-4">
        ...
        <div>
          <h5 className="fw-bold mb-0">Province Overview</h5>
          <small className="text-muted">Sleeping Cell Distribution Across Regions</small>
        </div>
        <div className="ms-auto">
          <div className="d-flex align-items-center">
            <div className="me-4 text-center">
              <h3 className="fw-bold text-primary mb-0">2</h3>
              <small className="text-muted">Total Provinces</small>
            </div>
            <div className="text-center">
              <h3 className="fw-bold text-success mb-0">79%</h3>
      ...
      <Row className="g-4">
        ...
        <Col lg={6}>
          <div className="mb-3">
            <h6 className="fw-bold mb-3">Province Statistics</h6>
            
            {/* SLA Province */}
            <div className="d-flex align-items-center mb-3 p-3 rounded" style={{backgroundColor: '#f8f9fa', border: '1px solid #e9ecef'}}>
              <div className="me-3">
                <div className="rounded-circle d-flex align-items-center justify-content-center" 
                     style={{width: '48px', height: '48px', backgroundColor: '#10b981', color: 'white'}}>
                  <span style={{fontSize: '1.2rem', fontWeight: 'bold'}}>SLA</span>
                </div>
              </div>
              <div className="flex-grow-1">
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <h6 className="mb-0 fw-bold">SLA Province</h6>
                  <Badge bg="success">100%</Badge>
                </div>
                <div className="d-flex align-items-center text-small mb-2">
                  <span className="text-muted me-3">📱 1 cell</span>
                  <span className="text-danger me-3">😴 1 sleeping</span>
            ...
            <div className="d-flex align-items-center mb-3 p-3 rounded" style={{backgroundColor: '#f8f9fa', border: '1px solid #e9ecef'}}>
              <div className="me-3">
                <div className="rounded-circle d-flex align-items-center justify-content-center" 
                     style={{width: '48px', height: '48px', backgroundColor: '#6366f1', color: 'white'}}>
                  <span style={{fontSize: '1.2rem', fontWeight: 'bold'}}>OTH</span>
                </div>
              </div>
              <div className="flex-grow-1">
                <div className="d-flex justify-content-between align-items-center mb-1">
                  <h6 className="mb-0 fw-bold">Other Regions</h6>
                  <Badge bg="warning">78%</Badge>
                </div>
                <div className="d-flex align-items-center text-small mb-2">
                  <span className="text-muted me-3">📱 64 cells</span>
                  <span className="text-danger me-3">😴 64 sleeping</span>
                  <span className="text-success">✅ 50 recovered</span>
                </div>
                <div className="progress" style={{height: '6px', borderRadius: '3px'}}>
        ...
        <Col lg={6}>
          <div className="mb-3">
            ...
            {/* Simple Bar Chart */}
            <div className="position-relative" style={{height: '200px', background: 'linear-gradient(45deg, #f8f9fa 0%, #e9ecef 100%)', borderRadius: '12px', padding: '20px'}}>
              
              {/* Chart Title */}
              <div className="text-center mb-3">
                <small className="text-muted fw-medium">Sleeping Cells by Province</small>
              </div>
              
              {/* Chart Bars */}
              <div className="d-flex align-items-end justify-content-center h-75 gap-4">
                ...
                <div className="text-center">
                  <div className="d-flex flex-column align-items-center">
                    ...
                    <div style={{fontSize: '12px', fontWeight: 'bold', color: '#6b7280'}}>SLA</div>
                ...
                <div className="text-center">
                  <div className="d-flex flex-column align-items-center">
                    ...
                    <div style={{fontSize: '12px', fontWeight: 'bold', color: '#6b7280'}}>Other</div>
                    <div style={{fontSize: '10px', color: '#9ca3af'}}>78%</div>
                  </div>
                </div>
              ...
              <div className="position-absolute bottom-0 start-0 end-0 d-flex justify-content-center">
                <div className="d-flex align-items-center gap-3">
                  <div className="d-flex align-items-center">
                    ...
                    <small style={{fontSize: '10px', color: '#6b7280'}}>High Success</small>
                  </div>
                  <div className="d-flex align-items-center">
                    <div style={{width: '12px', height: '12px', backgroundColor: '#6366f1', borderRadius: '2px', marginRight: '6px'}}></div>
                    <small style={{fontSize: '10px', color: '#6b7280'}}>Need Attention</small>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-3">
              <Row className="g-2">
                <Col xs={6}>
                  <div className="text-center p-2 rounded" style={{backgroundColor: '#ecfdf5', border: '1px solid #a7f3d0'}}>
                    <div className="fw-bold text-success">1</div>
                    <small className="text-muted">Perfect Score</small>
                  </div>
                </Col>
                <Col xs={6}>
                  <div className="text-center p-2 rounded" style={{backgroundColor: '#fef3c7', border: '1px solid #fbbf24'}}>
                    <div className="fw-bold text-warning">64</div>
