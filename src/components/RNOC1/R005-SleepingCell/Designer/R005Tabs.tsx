...
*/}
              ...
              <div
                style={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                  boxShadow: activeTab === "dashboard" ? "0 4px 12px rgba(37, 99, 235, 0.25)" : activeTab === "monitor" ? "0 4px 12px rgba(5, 150, 105, 0.25)" : "0 4px 12px rgba(124, 58, 237, 0.25)",
                }}
              >
                {createIcon(activeTab === "dashboard" ? FiBarChart : activeTab === "monitor" ? FiEye : FiSettings, {
                  size: 24,
                  color: "white",
                  strokeWidth: 2.5,
                })}
