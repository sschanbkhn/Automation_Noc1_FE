...
import devicePortsFormInputJson from './FormInput.json';
interface Props {
  Id: string,
...
const DevicePortsForm = (props: Props) => {  
  const [state, dispatch] = useReducer(Reducer, InitState)
  useEffect(() => {
    Actions.GetItem(props.Id, dispatch);
  }, [props.Id])
  let devicePortsFormInput:any = devicePortsFormInputJson;
  ...
  return(
    <>
      ...
      <CtrlDynamicForm options={props.Options} ref={refDynamicForm} initValues={state.DataItem} formDefs={devicePortsFormInput} actionEvents={ActionEvents} />
    </>
  )
}
...
export default connect(mapState, mapDispatchToProps)(DevicePortsForm);