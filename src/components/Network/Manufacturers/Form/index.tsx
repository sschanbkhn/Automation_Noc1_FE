...
import manufacturersFormInputJson from './FormInput.json';
interface Props {
  Id: string,
...
const ManufacturersForm = (props: Props) => {  
  ...
  let manufacturersFormInput:any = manufacturersFormInputJson;
  ...
  return(
    <>
      ...
      <CtrlDynamicForm ref={refDynamicForm} initValues={state.DataItem} formDefs={manufacturersFormInput} actionEvents={ActionEvents} />
    </>
  )
}
...
export default connect(mapState, mapDispatchToProps)(ManufacturersForm);