...
import curenAlarmFormInputJson from './FormInput.json';
interface Props {
  Id: string,
...
const CurenAlarmForm = (props: Props) => {  
  const [state, dispatch] = useReducer(Reducer, InitState)
  useEffect(() => {
    Actions.GetItem(props.Id, dispatch);
  }, [props.Id])
  let curenAlarmFormInput:any = curenAlarmFormInputJson;
  ...
  return(
    <>
      ...
      <CtrlDynamicForm options={props.Options} ref={refDynamicForm} initValues={state.DataItem} formDefs={curenAlarmFormInput} actionEvents={ActionEvents} />
    </>
  )
}
...
export default connect(mapState, mapDispatchToProps)(CurenAlarmForm);